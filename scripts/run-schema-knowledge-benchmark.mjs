...
const reportPath = resolve('reports/database-capability/schema-knowledge-performance.json');
const observedAt = '2026-07-24T00:00:00.000Z';
const source = {
  sourceId: 'schema-knowledge-benchmark',
  sourceType: 'connector',
  connectionProfileId: 'schema-knowledge-benchmark',
  observedAt,
};
...
let catalog = buildKnowledgeCatalog({
  connectionId: 'schema-knowledge-benchmark',
...
const wideIndex = wideEngine.index({
  connectionId: 'schema-knowledge-wide-parent',
...
const report = {
  kind: 'database-schema-knowledge-performance',
  ...
  dataset: {
    ...
    searchableDocuments: engine.getIndexStatus('schema-knowledge-benchmark').documentCount,
...
engine.clear('schema-knowledge-benchmark');
wideEngine.clear('schema-knowledge-wide-parent');
dataset = undefined;
catalog = undefined;
