...
- 前七次 GitHub Actions 发布复验（runs `34757899868`、`34761714006`、`34763736333`、`34764907067`、
  `34767085788`、`34768751691`、`34770047563`）
  先后暴露发布环境合同
  ...
  非时序合同声明 15 秒测试预算，不放宽整个包或任何生产 deadline；最终状态以最新 Actions 运行结果为准。
