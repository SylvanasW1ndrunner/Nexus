...
Use this skill for database-facing implementation and validation.
...
Read `docs/product/02-rag-design.md` only when schema metadata feeds indexing or retrieval.
