---
name: dbagent-product-planning
description: Plan DBAgent product modules, milestones, scope, acceptance criteria, and next implementation slices for the NL2SQL and AI database operations product. Use when deciding what to build next, reconciling product scope, or updating roadmap and architecture docs.
---

# DBAgent Product Planning
...
6. Prefer PostgreSQL depth and read-only operations before adding databases or write actions.
