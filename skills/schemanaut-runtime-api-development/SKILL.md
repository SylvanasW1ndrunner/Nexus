---
name: schemanaut-runtime-api-development
description: Implement or refactor SchemaNaut Runtime, TypeScript SDK, REST API, CLI, lightweight WebUI management endpoints, public contracts, run state, cancellation, or lifecycle wiring. Use for work in packages/sdk, packages/shared, or apps/server.
---

# SchemaNaut Runtime and API Development
