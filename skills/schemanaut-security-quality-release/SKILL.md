...
description: Review SchemaNaut security boundaries, dependencies, tests, PostgreSQL integration, observability, npm packaging, release readiness, or documentation consistency. Use before commits, releases, dependency changes, or when deciding whether a feature is genuinely complete.
---
