...
export const DEFAULT_OFFICIAL_PLUGIN_MANIFESTS: OfficialPluginManifest[] = [
  ...
  },
  {
    ...
    enabledByDefault: true,
    capabilities: ['workspace-list', 'workspace-read', 'workspace-search', 'workspace-write', 'workspace-delete'],
    permissions: [
      permission(
        'workspace.file.read',
        '读取工作区文件',
