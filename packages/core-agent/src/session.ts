...
export function createAgentSession(input: {
  ...
  return {
    ...
    ...(input.capabilityStates === undefined
      ? {}
      : { capabilityStates: structuredClone(input.capabilityStates) }),
...
export function forkAgentSessionForSubagent(input: {
  ...
  return {
    ...
    ...(input.parent.modelBinding === undefined
      ? {}
      : { modelBinding: structuredClone(input.parent.modelBinding) }),
    ...(input.parent.capabilityStates === undefined
      ? {}
      : { capabilityStates: structuredClone(input.parent.capabilityStates) }),
